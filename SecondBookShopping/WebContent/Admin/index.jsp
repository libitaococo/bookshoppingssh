...
<div class="loginBox">
	...
	<s:form action="admin_login" method="post" namespace="/">
			...
			<ul class="login">
				...
				<li><input type="submit" name="submit" value="" class="login_btn"></li>
			</ul>
	</s:form>
	</div>
</div>
...
<div class="footer">
	...
	<p class="web"><a href="#"><img src="${pageContext.request.contextPath}/Admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="${pageContext.request.contextPath}/Admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="${pageContext.request.contextPath}/Admin/images/webLogo.jpg" alt="logo"></a><a href="#"><img src="images/webLogo.jpg" alt="logo"></a></p>
</div>
</body>
</html>
