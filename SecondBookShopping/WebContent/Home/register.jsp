...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="yrh" align="center">
  <tr>
    <td height="17"><a href="index_list.action">主页</a> &raquo; 新用户注册</td>
  </tr>
</table>
<table width="770" border="0" cellpadding="0" cellspacing="0" class="main" align="center">
<tr valign="top">
<td><form action="user_register" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%" border="0" cellpadding="2" cellspacing="1" class="inputTable" align="center">
    <tr>
      <td class="inputTitle">新用户注册 <s:actionerror/></td>
    </tr>
    <tr>
      <td>
        <table width="100%" border="0" cellpadding="0" cellspacing="1" class="inputbox">
          <tr>
            ...
            <td width="17%" class="inputHeader">请输入E-mail 地址：</td>
            <td width="38%" class="inputContent">
              <input type="Text" class="text width100" name="email" maxlength="25">
            </td>
              <td width="41%" class="inputContent">&nbsp;<font color="#CC0000">*&nbsp;必输项</font></td>
          </tr>
          <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader">请输入用户名：</td>
            <td class="inputContent">
              <input type="Text" class="text width100" name="user" value="" maxlength="25">
            </td>
            <td width="41%" class="inputContent">&nbsp;<font color="#CC0000">*&nbsp;必输项</font></td>
          </tr>
          <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader">请输入昵称：</td>
            <td class="inputContent">
              <input type="Text" class="text width100" name="name" value="" maxlength="25">
            </td>
            <td class="inputContent"> <font color="#CC0000">&nbsp; &nbsp;(可选项)</font></td>
          </tr>
          <tr>
            <td class="inputHeader">&nbsp;</td>
          ...
          <tr>
            <td class="inputHeader">&nbsp;</td>
            <td class="inputHeader">密码确认：</td>
            <td class="inputContent">
              <input type="Password" class="text width100" name="passwordConfirm" value="" maxlength="25">
            </td>
            <td class="inputContent">&nbsp;<font color="#CC0000">*&nbsp;必输项</font></td>
          </tr>
...
<input type="submit" class="bt2" name="button2" value="提交" onClick="if(checkregform()==true) window.location.href='user_register.action';else return false;">
&nbsp;
&nbsp;
&nbsp;
